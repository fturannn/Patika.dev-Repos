...
public class OperatorGUI extends JFrame {
    ...
    public OperatorGUI(Operator operator) {
        ...
        mdl_patika_list.setColumnIdentifiers(col_patika_list); //column isimlerini ekler
        ...
        // Çıkış yap'a tıklanıldığında programı kapatır
        btn_logout.addActionListener(e -> {
            dispose();
            LoginGUI login = new LoginGUI();
        });

        // Ekleme butonu çalışması
    ...
    private void loadPatikaModel() {
        ...
        clearModel.setRowCount(0); // İçerideki tüm verileri temizler
        int i;
    ...
    public void loadEducatorCombo() {
        ...
        for (User obj : User.getList()) {
            if (obj.getType().equals("educater")) {
