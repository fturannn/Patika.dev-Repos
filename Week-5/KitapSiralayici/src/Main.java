...
public class Main {
    public static void main(String[] args) {
        ...
        book2.add(new Book("Hayvan Çiftliği", 152, "George Orwell", 1945));
        book2.add(new Book("Satranç", 192, "Stefan Zweig", 1942));
        book2.add(new Book("Küçük Prens", 112, "Antoine de Saint-Exupéry", 1945));
        book2.add(new Book("Şeker Portakalı", 182, "José Mauro de Vasconcelos", 1968));
        book2.add(new Book("Dönüşüm", 104, "Franz Kafka", 1915));
